            ...
            <div className="card p-6 space-y-6">
              ...
              <div className="space-y-2 px-3">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all text-sm font-bold"
                />
                <p className="text-xs text-slate-500 dark:text-slate-400 italic">
