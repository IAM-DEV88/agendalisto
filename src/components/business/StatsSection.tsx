...
const StatsSection: React.FC<StatsSectionProps> = ({
  ...
  return (
    <div>
      <h2 className="text-lg font-medium text-gray-900  mb-4">Estadísticas del negocio</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
        ...
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">{confirmationRate.toFixed(2)}%</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">{cancellationRate.toFixed(2)}%</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">{avgDuration.toFixed(1)} min</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">${avgPrice.toFixed(2)}</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">{topServiceName} ({topServiceCount})</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">{topClientName} ({topClientCount})</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">{peakDay}, {peakHour}:00</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">{newClients}</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">{returningClients}</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-xl font-semibold text-gray-900 ">${lifetimeValueAvg.toFixed(2)}</p>
          </div>
        </div>
        <div className="bg-gray-50 dark:bg-gray-800 shadow rounded-lg p-6 flex items-center">
