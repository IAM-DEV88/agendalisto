  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        disabled={loading}
        className="inline-flex items-center gap-2 px-3 py-2 text-sm font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all w-full"
      >
      ...
      {open && (
        <div className="absolute left-0 sm:left-auto sm:right-0 mt-2 w-64 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-right">
          <div className="p-2 space-y-0.5">
            {currentBusiness && (
              <button
                type="button"
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary-50 dark:bg-primary-500/10 text-sm font-bold text-primary-700 dark:text-primary-400"
              >
            ...
            {otherBusinesses.map(biz => (
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-medium text-slate-700 dark:text-slate-300 transition-colors text-left"
              >
          ...
          <div className="border-t border-slate-100 dark:border-slate-800 p-2">
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-sm font-bold text-primary-600 dark:text-primary-400 transition-colors"
            >
