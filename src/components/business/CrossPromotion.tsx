    ...
    <div className="bg-amber-50 dark:bg-amber-900/10 rounded-lg p-5 border border-amber-200 dark:border-amber-800/50 mt-6">
      ...
      <div className="space-y-2">
        {nearby.map(b => (
          ...
          >
            <img src={b.logo_url || FALLBACK_BUSINESS_LOGO} alt={`${b.name || 'Negocio'} logo`} loading="lazy" className="w-10 h-10 rounded-lg object-cover bg-slate-100" onError={e => { (e.target as HTMLImageElement).src = FALLBACK_BUSINESS_LOGO; }} />
