  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className="inline-flex items-center justify-center gap-1.5 px-3 h-9 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 text-xs font-bold rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all shadow-sm shrink-0"
      >
        ...
        <div className="absolute left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-0 top-full mt-2 z-50 w-72 max-w-[calc(100vw-2rem)] bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 shadow-2xl p-5 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-bold text-sm rounded-lg transition-all"
            >
