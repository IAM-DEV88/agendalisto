    ...
    <div className="animate-in fade-in zoom-in-95 duration-300 space-y-5">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-5 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row items-stretch gap-3">
          <div className="flex-1 flex items-center gap-2 px-4 py-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700 text-sm font-mono text-slate-600 dark:text-slate-300 truncate">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-primary-600 hover:bg-primary-700 text-white px-5 py-3 rounded-lg font-bold text-sm transition-all flex items-center gap-2 shadow-lg shadow-primary-500/20"
            >
        ...
        {loadingUsers ? (
          ...
          <div className="space-y-2">
            {referredUsers.map(user => (
              <div
                key={user.id}
                className="flex items-center gap-4 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 hover:bg-white dark:hover:bg-slate-800 transition-all"
              >
