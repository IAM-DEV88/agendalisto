        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl p-6 sm:p-8">
          ...
          {step === 0 && (
            <div className="space-y-6">
              {showSuggestModal && (
                <div className="bg-primary-50 dark:bg-primary-900/20 rounded-2xl p-5 border border-primary-200 dark:border-primary-800/50">
                  ...
                  <div className="flex gap-3">
                    <button onClick={acceptDefaults} className="px-5 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-bold text-sm rounded-xl transition-all">
                      Agregar sugeridos
                    </button>
                    <button onClick={skipDefaults} className="px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-bold text-sm rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all">
                      Empezar vacío
                    </button>
                  </div>
                </div>
              ...
              <div className="border-t border-slate-100 dark:border-slate-800 pt-5 space-y-3">
                ...
                <button
                  onClick={addService}
                  className="w-full py-3 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-bold text-sm rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
                >
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-slate-100 dark:border-slate-800">
            <div className="flex gap-3">
              {step > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-bold text-sm rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
                >
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={handleNext}
                disabled={saving}
                className="flex items-center gap-2 px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-bold text-sm rounded-xl transition-all disabled:opacity-50 shadow-lg shadow-primary-500/20"
              >
...
function ShareStep({ businessSlug }: { businessSlug: string }) {
  ...
  return (
    <div className="space-y-6 text-center">
      ...
      <div className="flex items-center gap-2 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700 text-sm text-slate-600 dark:text-slate-300 truncate">
