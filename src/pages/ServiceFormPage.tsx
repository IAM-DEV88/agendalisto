              ...
              <div className="space-y-5">
                ...
                <div className="space-y-1">
                  ...
                  <DescriptionGenerator
                    ...
                    onSelect={value => setFormData(prev => ({ ...prev, description: value }))}
                    generateFn={() => generateServiceDescription(formData.name, businessName)}
                    optionLabels={['🎯 Enfoque en resultados', '✨ Enfoque en proceso']}
                    validate={() => !formData.name.trim() ? 'Primero escribe el nombre del servicio' : null}
                  />
                </div>
