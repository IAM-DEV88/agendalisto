    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          <div className="w-16 h-16 mx-auto mb-5 rounded-lg bg-amber-50 dark:bg-amber-500/10 flex items-center justify-center">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-8 mb-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.step} className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg">
        ...
        <div className="text-center">
          {!isLoggedIn ? (
            <Link
              to="/register"
              onClick={handleLead}
              className="inline-flex items-center gap-2 px-6 py-3.5 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-lg transition-all shadow-lg shadow-amber-500/25"
            >
