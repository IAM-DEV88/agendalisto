          ...
          <>
            ...
            {giftCode ? (
              <div className="mb-8">
                ...
                <p className="text-2xl font-black text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 px-6 py-3 rounded-xl inline-block border border-primary-200 dark:border-primary-800">
                  {giftCode}
                </p>
