...
-- DELETE FROM agendaya_business_config WHERE business_id IN (
...
-- );
-- DELETE FROM agendaya_businesses WHERE id IN (
--   '18a5f9bd-cdc2-45cc-b95e-6554899996d1',
--   '18a5f9bd-cdc2-45cc-b95e-6554899996d2',
--   '18a5f9bd-cdc2-45cc-b95e-6554899996d3',
--   '18a5f9bd-cdc2-45cc-b95e-6554899996d4',
...
--   '18a5f9bd-cdc2-45cc-b95e-6554899996d8'
-- );
-- DELETE FROM agendaya_profiles WHERE id IN (
...
INSERT INTO agendaya_profiles (id, full_name, phone, email, created_at, updated_at) VALUES
...
-- Insert businesses
INSERT INTO agendaya_businesses (id, owner_id, category_id, name, slug, description, address, phone, email, created_at, updated_at) VALUES
-- Pitalito Businesses
